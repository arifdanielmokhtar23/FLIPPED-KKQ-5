...
import { SELECT_ARROW_SVG_URL } from './hijazConstants';

interface HijazDropdownProps<T extends string> {
  id: string;
  label: string;
...
const HijazDropdown = <T extends HijazHarakahOptionValue | HijazHummingOptionValue>({ 
  id, 
  label, 
  options, 
  selectedValue, 
  onChange 
}: HijazDropdownProps<T>) => {
  return (
    <div className="mb-4">
