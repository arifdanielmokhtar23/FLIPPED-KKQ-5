...
interface NahawandAudioControlsProps {
  onPlayRequest: () => void; // Renamed from onPlay
  onStop: () => void;
  isPlaying: boolean;
}

const NahawandAudioControls: React.FC<NahawandAudioControlsProps> = ({ onPlayRequest, onStop, isPlaying }) => {
  return (
...
export default NahawandAudioControls;
