...
import { ArrowPattern } from './nahawandTypes';
...
interface NahawandMelodicDirectionDisplayProps {
  arrowPattern: ArrowPattern | null;
}

const NahawandMelodicDirectionDisplay: React.FC<NahawandMelodicDirectionDisplayProps> = ({ arrowPattern }) => {
  if (!arrowPattern) {
    return (
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 md:p-5 border border-gray-200" aria-labelledby="melodic-direction-title-nahawand">
      <div className="bg-slate-50 rounded-xl p-3 sm:p-4 md:p-6 border border-gray-200">
        <h3 id="melodic-direction-title-nahawand" className="text-primary text-base sm:text-lg md:text-xl font-semibold mb-4 text-center">
          Arah Melodi
        </h3>
...
export default NahawandMelodicDirectionDisplay;
