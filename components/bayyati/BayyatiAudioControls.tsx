...
interface BayyatiAudioControlsProps {
  onPlayRequest: () => void; // Renamed from onPlay
  onStop: () => void;
  isPlaying: boolean;
}

const BayyatiAudioControls: React.FC<BayyatiAudioControlsProps> = ({ onPlayRequest, onStop, isPlaying }) => {
  return (
    <div className="flex items-center justify-center space-x-4 mt-4">
      <button
        onClick={onPlayRequest} // Use the renamed prop
...
export default BayyatiAudioControls;
